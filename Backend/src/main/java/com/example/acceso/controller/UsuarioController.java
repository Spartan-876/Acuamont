...
public class UsuarioController {
    ...
    // GET /usuarios/listar: Muestra la página HTML principal de gestión de usuarios.
    @GetMapping("/listar")
    public String listarUsuarios(Model model) {
        // Aunque el listado se hace por API, este método prepara el modelo inicial
        // por si se quisiera renderizar algo desde el servidor.
    ...
    // GET /usuarios/api/listar: Endpoint de la API que devuelve la lista de usuarios en formato JSON.
    // @ResponseBody: Indica que el valor de retorno del método debe ser el cuerpo de la respuesta, no el nombre de una vista.
    ...
    // @Valid: Activa las validaciones definidas en el modelo Usuario (ej. @NotBlank).
    ...
    public ResponseEntity<?> guardarUsuarioAjax(@Valid @RequestBody Usuario usuario, BindingResult bindingResult) {
        ...
        try {
            ...
            // Captura cualquier excepción del servicio (ej. usuario duplicado) y la devuelve como error.
            response.put("success", false);
