...
$(document).ready(function() {
    ...
    /**
     * Configura el sidebar responsivo
     */
    ...
    function savePerfiles() {
        ...
        .then(data => {
            if (data.success) {
                ...
                loadPerfiles(); // Recargar la tabla
            } else {
                if (data.errors) {
    ...
    function handleDelete(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                .catch(error => {
                    console.error('Error:', error);
                    showNotification('Error de conexión al eliminar perfil', 'error');
                })
                .finally(() => {
                    showLoading(false);
                });
    ...
    function clearForm() {
        ...
        $('#formPerfiles .form-control').removeClass('is-invalid');
